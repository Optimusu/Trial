...
{
    [ApiVersion("1.0")]
    [Route("api/v{version:apiVersion}/edocstudies")]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Roles = "Administrator")]
    [ApiController]
    public class EdocStudiesController : ControllerBase
    {
        private readonly IEdocStudyUnitOfWork _unitOfWork;
        private readonly IStringLocalizer _localizer;

        public EdocStudiesController(IEdocStudyUnitOfWork unitOfWork, IStringLocalizer localizer)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> PutAsync(EdocStudy modelo)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> PostAsync(EdocStudy modelo)
        {
            try
            {
                ClaimsDTOs userClaimsInfo = User.GetEmailOrThrow(_localizer);
