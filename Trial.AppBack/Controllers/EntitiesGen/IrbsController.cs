...
{
    [ApiVersion("1.0")]
    [Route("api/v{version:apiVersion}/irbs")]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Roles = "Administrator")]
    [ApiController]
    public class IrbsController : ControllerBase
    {
        private readonly IIrbUnitOfWork _unitOfWork;
        private readonly IStringLocalizer _localizer;

        public IrbsController(IIrbUnitOfWork unitOfWork, IStringLocalizer localizer)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> PutAsync(Irb modelo)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> PostAsync(Irb modelo)
        {
            try
            {
                ClaimsDTOs userClaimsInfo = User.GetEmailOrThrow(_localizer);
