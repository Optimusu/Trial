...
namespace Trial.AppBack.Migrations
{
    ...
    [Migration("20250808180935_edocStudiesDB")]
    partial class edocStudiesDB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Trial.Domain.EntitesSoftSec.UsuarioRole", b =>
                {
            ...
            modelBuilder.Entity("Trial.Domain.Entities.City", b =>
                {
            ...
            modelBuilder.Entity("Trial.Domain.Entities.Corporation", b =>
                {
                    b.Property<int>("CorporationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Trial.Domain.Entities.Country", b =>
                {
                    b.Property<int>("CountryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Trial.Domain.Entities.Manager", b =>
                {
            ...
            modelBuilder.Entity("Trial.Domain.Entities.SoftPlan", b =>
                {
                    b.Property<int>("SoftPlanId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Trial.Domain.Entities.State", b =>
                {
                    b.Property<int>("StateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Trial.Domain.Entities.UserRoleDetails", b =>
                {
            ...
            modelBuilder.Entity("Trial.Domain.EntitiesStudy.EdocCategory", b =>
                {
                    ...
                    b.HasIndex("NameContainer")
                        .IsUnique()
                        .HasFilter("[NameContainer] IS NOT NULL");
            ...
            modelBuilder.Entity("Trial.Domain.EntitiesStudy.EdocStudy", b =>
                {
                    b.Property<Guid>("EdocStudyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("NEWSEQUENTIALID()");
                    ...
                    b.HasKey("EdocStudyId");

                    b.HasIndex("CorporationId");

                    b.HasIndex("EdocCategoryId");

                    b.HasIndex("EdocStudyId");

                    b.HasIndex("StudyId");

                    b.HasIndex("FileNameOriginal", "CorporationId")
                        .IsUnique()
                        .HasFilter("[FileNameOriginal] IS NOT NULL");

                    b.ToTable("EdocStudies");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Trial.Domain.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Trial.Domain.Entities.City", b =>
                {
                    b.HasOne("Trial.Domain.Entities.State", "State")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("Trial.Domain.Entities.Corporation", b =>
                {
                    b.HasOne("Trial.Domain.Entities.Country", "Country")
                        .WithMany("Corporations")
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Trial.Domain.Entities.SoftPlan", "SoftPlan")
                        .WithMany("Corporations")
            ...
            modelBuilder.Entity("Trial.Domain.Entities.UserRoleDetails", b =>
                {
                    b.HasOne("Trial.Domain.Entities.User", "User")
            ...
            modelBuilder.Entity("Trial.Domain.EntitiesStudy.EdocStudy", b =>
                {
                    ...
                    b.HasOne("Trial.Domain.EntitiesStudy.EdocCategory", "EdocCategory")
                        .WithMany("EdocStudies")
                        .HasForeignKey("EdocCategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
