...
namespace Trial.AppFront.Pages.EntitiesGen.CroPage;

public partial class IndexCro
{
    ...
    private const string baseUrl = "api/v1/cros";
    public List<Cro>? Cros { get; set; }
    ...
    private async Task Cargar(int page = 1)
    {
        ...
        var responseHttp = await _repository.GetAsync<List<Cro>>(url);
    ...
    private async Task ShowModalAsync(int id = 0, bool isEdit = false)
    {
        if (isEdit)
        {
            ...
            await _modalService.ShowAsync<EditCro>(parameters);
        }
        else
        {
            var parameters = new Dictionary<string, object>
            ...
            await _modalService.ShowAsync<CreateCro>(parameters);
        }
    }
