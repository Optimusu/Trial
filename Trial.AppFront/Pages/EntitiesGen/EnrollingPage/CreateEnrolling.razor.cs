...
public partial class CreateEnrolling
{
    //Services
    ...
    private Enrolling _enrolling = new() { Active = true };
    private string BaseUrl = "/api/v1/enrollings";
    private string BaseView = "/enrollings";

    private async Task Create()
    {
        var responseHttp = await _repository.PostAsync($"{BaseUrl}", _enrolling);
