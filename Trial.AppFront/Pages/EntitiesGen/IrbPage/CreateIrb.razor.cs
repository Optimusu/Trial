...
public partial class CreateIrb
{
    //Services
    ...
    private Irb _irb = new() { Active = true };
    private string BaseUrl = "/api/v1/irbs";
    private string BaseView = "/irbs";

    private async Task Create()
    {
        var responseHttp = await _repository.PostAsync($"{BaseUrl}", _irb);
