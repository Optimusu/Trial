...
public partial class CreateSponsor
{
    ...
    private Sponsor _sponsor = new() { Active = true };
    private string BaseUrl = "/api/v1/sponsors";
    private string BaseView = "/sponsors";

    private async Task Create()
    {
        var responseHttp = await _repository.PostAsync($"{BaseUrl}", _sponsor);
