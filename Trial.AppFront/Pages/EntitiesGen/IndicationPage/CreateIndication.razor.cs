...
public partial class CreateIndication
{
    //Services
    ...
    private Indication _indication = new() { Active = true };
    private string BaseUrl = "/api/v1/indications";
    private string BaseView = "/indications";

    private async Task Create()
    {
        var responseHttp = await _repository.PostAsync($"{BaseUrl}", _indication);
